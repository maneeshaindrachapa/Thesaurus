...
######################################################
datasets = {
    'Tamil_Chunk':                                   #Name of the dataset
        {'columns': {0:'tokens', 2:'Chunk_BIO'},    #CoNLL format for the input data. Column 1 contains tokens, column 2 contains NER information using BIO encoding
