...
from util.preprocessing_sin import perpareDataset, loadDatasetPickle
...
######################################################
datasets = {
    'Sinhala_News':                                   #Name of the dataset
        {'columns': {0:'tokens', 1:'POS'},    #CoNLL format for the input data. Column 1 contains tokens, column 2 contains NER information using BIO encoding
...
embeddingsPath = 'final_sinhala.txt'
...
params = {'classifier': ['CRF'], 'LSTM-Size': [100, 100], 'dropout': (0.25, 0.25), 'charEmbeddings': 'CNN', 'maxCharLength': 30}
